...
optimizer=tf.keras.optimizers.SGD(lr=0.000001, momentum=0.1, decay=0.0, nesterov=False) # lr=0.01, decay=1e-6, momentum=0.9, nesterov=True
# https://junstar92.tistory.com/103

es= EarlyStopping(monitor='val_loss', patience=10)
reduce_lr = ReduceLROnPlateau(monitor='val_loss', patience=5, factor=0.5, verbose=1)
cp = ModelCheckpoint('../data/h5/Dense_momentum.hdf5', monitor='val_loss', save_best_only=True, verbose=1,mode='auto')
...
# model = load_model('../data/h5/Dense_0514.hdf5', custom_objects={'leaky_relu': tf.nn.leaky_relu})
...
df['test'] = y_pred
df.to_csv('../data/csv/Dense_momentum.csv',index=False)
