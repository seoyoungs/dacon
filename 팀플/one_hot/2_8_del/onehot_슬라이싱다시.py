...
cp = ModelCheckpoint('../data/h5/LSTM/Dense_0513.hdf5', monitor='val_loss', save_best_only=True, verbose=1,mode='auto')
model.compile(loss='mse', optimizer='adam', metrics='mae')
model.fit(x_train, y_train, epochs=50, batch_size=2000, validation_data=(x_val,y_val), callbacks=[reduce_lr,cp] )
...
loss, mae = model.evaluate(x_pred, y_pred, batch_size=2000)
