...
for train_index, test_index in kfold.split(x_train): 
    ...
    # 3. 컴파일 훈련
    # model = load_model('../data/h5/regressor3_2_'+str(num)+'.hdf5', custom_objects={'leaky_relu': tf.nn.leaky_relu})
    mc = ModelCheckpoint('../data/h5/regressor11_'+str(num)+'.hdf5',save_best_only=True, verbose=1)
