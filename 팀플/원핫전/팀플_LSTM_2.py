...
for main_num in range(1):# 반복 range(1) 16으로 할지 안할지
    ...
    x_train, y_train = split_xy(train_value, 2688, 2688) # output 2688
    ...
    for train_index, test_index in kfold.split(x_train): 
        ...
        x_train1, x_val, y_train1, y_val = train_test_split(x_train1, y_train1,  train_size=0.9, random_state = 77, shuffle=True ) # shuffle= False
        ...
        x = Dense(16)(x)
        x = Activation(mish)(x)
        outputs = Dense(2688)(x) # 여기다가 2688 넣는게 맞나?
