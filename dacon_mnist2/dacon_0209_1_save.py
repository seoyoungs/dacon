...
# train 데이터
train = pd.read_csv('C:/data/dacon_mnist2/train.csv')
...
np.save('C:/data/dacon_mnist2/npy_data/x_data_save.npy', arr=x_train)
np.save('C:/data/dacon_mnist2/npy_data/y_data_save.npy', arr=y_train)
